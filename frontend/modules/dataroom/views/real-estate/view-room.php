...
<div class="page-offer-synthesis container">
    ...
    <div class="row">
        <div class="block-half block-half_left col-lg-6">
            ...
            <ul class="info-list">
                <li><strong><?= $model->getAttributeLabel('propertyType') ?></strong> : <?= RoomRealEstate::getPropertyTypeCaption($model->propertyType) ?></li>
                <li><strong><?= $model->getAttributeLabel('propertySubType') ?></strong> : <?= RoomRealEstate::getPropertySubTypeCaption($model->propertySubType) ?></li>
                <li><strong><?= $model->getAttributeLabel('regionID') ?></strong> : <?= $model->getRegionName() ?></li>
                <li><strong><?= $model->getAttributeLabel('status') ?></strong> : <?= RoomRealEstate::getStatusCaption($model->status) ?></li>
            </ul>
        ...
        <div class="block-half block-half_right col-lg-6">
            ...
            <ul class="info-list">
                <li><strong>Nature procédure</strong> : <?= RoomRealEstate::getProcedureCaption($model->procedure) ?></li>
