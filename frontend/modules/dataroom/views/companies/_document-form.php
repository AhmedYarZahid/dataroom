            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <?= $form->field($model, 'parentID')->begin(); ?>
                        <?= Html::activeLabel($model, 'parentID', ['class' => 'control-label']) ?>

                        <?php echo yii2mod\tree\Tree::widget([
                            'id' => 'folders-tree',
                            'items' => Document::getRoomDocumentsTree($this->context->detailedRoomModel->roomID, $model->parentID),
                            'clientOptions' => [
                                'selectMode' => 1,
                                ...
                                "),
                                'beforeActivate' => new \yii\web\JsExpression("
                                    function(event, data) {
