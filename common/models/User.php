...
class User extends ActiveRecordHistory implements IdentityInterface
{
    ...
    public function getTargetSector()
    {
        return $this->profileCompany->targetedSector ?? null;
    }

    public function getTurnoverName()
    {
        return $this->profileCompany->turnoverName ?? null;
    }


    public function getGeographicalAreaName()
    {
        return $this->profileCompany->geographicalAreaName ?? null;
    }

    public function getTargetAmount()
    {
        return $this->profileCompany->targetAmountName ?? null;
    }

    public function getEffective()
    {
        return $this->profileCompany->effective ?? null;
    }

    public function getEntryTicket()
    {
        return $this->profileCompany->ticket ?? null;
    }
}
