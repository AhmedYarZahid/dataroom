            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'url' => '/admin/parameter/manage/index',
                    ...
                    [
                        ...
                        'items' => [
                            ...
                            [
                                ...
                                'url' => '/admin/contact/manage/index',
                            ...
                            [
                                ...
                                'url' => '/admin/trendypage/manage/index',
                            ...
                            [
                                ...
                                'url' => '/admin/staticpage/manage/index',
                            ...
                            [
                                ...
                                'url' => '/admin/comments/manage/index',
                                'active' => ($this->context->module->id == 'comments' && Yii::$app->controller->id == 'manage')
                            ],
                            [
                                'label' => '<i class="fa fa-list"></i> <span>' . Yii::t('admin', 'Professions') . '</span>',
                                'url' => '/admin/profession/index',
                                'active' => (Yii::$app->controller->id == 'profession')
                            ],
                        ],
                    ],
                    ...
                    [
                        ...
                        'url' => '/admin/document/manage/index',
