    ...
    'attributes' => [
        ...
        [
            ...
            'value' => $model->identityCard
                ...
                : null,
            'visible' => $model->personType == \backend\modules\dataroom\models\RoomAccessRequestRealEstate::PERSON_TYPE_PHYSICAL
        ],
        [
            'attribute' => 'cvID',
            'format' => 'raw',
        ...
        [
            ...
            'format' => 'ntext',
            'visible' => $model->personType == \backend\modules\dataroom\models\RoomAccessRequestRealEstate::PERSON_TYPE_LEGAL
        ],
        [
            'attribute' => 'companyPresentation',
            'format' => 'ntext',
            'visible' => $model->personType == \backend\modules\dataroom\models\RoomAccessRequestRealEstate::PERSON_TYPE_LEGAL
        ],
        [
        ...
        [
            'attribute' => 'registrationsUpdatedStatusID',
            'format' => 'raw',
            'value' => $model->registrationsUpdatedStatus
                ? \kartik\helpers\Html::a(Yii::t('admin', 'Download'), $model->registrationsUpdatedStatus->getDocumentUrl(), ['target' => '_blank', 'data-pjax' => 0])
                : null,
            'visible' => $model->personType == \backend\modules\dataroom\models\RoomAccessRequestRealEstate::PERSON_TYPE_LEGAL
        ],
        [
