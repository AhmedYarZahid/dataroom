...
<div class="room-index">
    ...
    <p>
        <?= Html::a(Yii::t('admin', 'Add Proposal'), ['coownership/proposal/create', 'roomId' => $this->context->detailedRoomModel->roomID], ['class' => 'btn btn-success']) ?>
    </p>
        ...
        'columns' => [
            ...
            [
                ...
                'detail' => function ($model, $key, $index, $column) {
                    return $this->render('/coownership/proposal/_expanded', ['model' => $model]);
                },
                'expandOneOnly' => true,
