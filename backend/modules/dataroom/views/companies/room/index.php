...
//$this->title = Yii::t('admin', 'Rooms');
$this->title = 'AJArepreneurs';
...
<div class="room-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'attribute' => 'mandateNumber',
                'label' => Yii::t('admin', 'Mandate number'),
                'value' => function($model) {
                    return $model->room->mandateNumber;
                }
            ],
            [
                'attribute' => 'roomTitle',
            ...
            [
                ...
                'label' => Yii::t('admin', 'Admin AJA'),
                'value' => function($model) {
                    return $model->room->admin->email;
                }
            ],
            [
            ...
            [
                ...
                'buttons' => [
                    'documents' => function ($url, $model, $key) {
                        $url = ['companies/room/manage-documents-tree', 'id' => $model->id];
                    ...
                    'add-proposal' => function ($url, $model, $key) {
                        $url = ['companies/proposal/create', 'roomId' => $model->roomID];
