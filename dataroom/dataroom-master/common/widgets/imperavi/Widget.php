...
class Widget extends BaseWidget
{
    ...
    const INLINE_JS_KEY = 'common/widgets/imperavi/';
    ...
    {
        if (!isset(Yii::$app->i18n->translations['common/widgets/imperavi']) && !isset(Yii::$app->i18n->translations['common/widgets/imperavi/*'])) {
            Yii::$app->i18n->translations['common/widgets/imperavi'] = [
                'class' => 'yii\i18n\PhpMessageSource',
                'basePath' => '@common/widgets/imperavi/messages',
                'forceTranslation' => true,
                'fileMap' => [
                    'common/widgets/imperavi' => 'imperavi.php'
                ]
            ];
        }
    }
