...
$this->params['breadcrumbs'][] = ['label' => '<i class="fa fa-table"></i> AJAsyndic', 'url' => ['coownership/room/index']];
$this->params['breadcrumbs'][] = ['label' => '<i class="fa fa-book"></i> ' . Yii::t('admin', 'Proposals'), 'url' => ['coownership/room/proposals', 'id' => $room->detailedRoom->id]];
...
<div class="room-form">
    ...
    <div class="box box-info">
        ...
        <div class="box-body">
            ...
            <?= $form->field($proposal, 'fullName')->textInput(['maxlength' => 100]) ?>
