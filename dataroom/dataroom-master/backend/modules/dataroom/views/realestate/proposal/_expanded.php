...
<?= DetailView::widget([
    ...
    'attributes' => [
        ...
        [
            'attribute' => 'balanceSheetID',
            'format' => 'raw',
            'value' => $model->balanceSheet
                ? \kartik\helpers\Html::a(Yii::t('admin', 'Download'), $model->balanceSheet->getDocumentUrl(), ['target' => '_blank', 'data-pjax' => 0])
                : null,
        ],
        [
            'attribute' => 'taxNoticeID',
            'format' => 'raw',
            'value' => $model->taxNotice
                ? \kartik\helpers\Html::a(Yii::t('admin', 'Download'), $model->taxNotice->getDocumentUrl(), ['target' => '_blank', 'data-pjax' => 0])
                : null,
        ],
    ],
]) ?>
