...
/**
 * RoomAccessRequestCoownershipSearch represents the model behind the search form about `backend\modules\dataroom\models\RoomAccessRequestCoownership`.
 */
class RoomAccessRequestCoownershipSearch extends RoomAccessRequestCoownership
{
    public $roomTitle;
    public $userEmail;
    public $isValidated;
    ...
    {
        return [
            [['accessRequestID', 'identityCardID', 'cvID', 'lastTaxDeclarationID', 'coownershipManagementReferenceID', 'kbisID', 'latestCertifiedAccountsID', 'capitalAllocationID'], 'integer'],
            [['personType', 'candidatePresentation', 'groupPresentation'], 'safe'],
    ...
    {
        $with = [
            'identityCard', 'cv', 'lastTaxDeclaration', 'kbis', 'coownershipManagementReference',
        ...
        $query = RoomAccessRequestCoownership::find()
            ->joinWith($joinWith)
            ->with($with)
    ...
    /*public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'coownershipManagementReferenceID' => $this->coownershipManagementReferenceID,
            'kbisID' => $this->kbisID,
        ...
        $query->andFilterWhere(['like', 'personType', $this->personType])
            ...
            ->andFilterWhere(['like', 'groupPresentation', $this->groupPresentation]);
