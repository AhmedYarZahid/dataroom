...
use app\modules\supervisormanager\components\supervisor\exceptions\ProcessConfigException;
use yii\base\Component;

/**
 * Class ProcessConfig
 *
 * @package app\modules\supervisormanager\components\supervisor\config
 */
