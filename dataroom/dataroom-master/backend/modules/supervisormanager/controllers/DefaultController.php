...
namespace app\modules\supervisormanager\controllers;

use Yii;
use app\modules\supervisormanager\components\filters\AjaxAccess;
use app\modules\supervisormanager\components\supervisor\config\ConfigFileHandler;
use app\modules\supervisormanager\components\supervisor\config\ProcessConfig;
use app\modules\supervisormanager\components\supervisor\control\Group;
use app\modules\supervisormanager\components\supervisor\control\MainProcess;
use app\modules\supervisormanager\components\supervisor\control\Process;
use app\modules\supervisormanager\components\supervisor\exceptions\ConnectionException;
use app\modules\supervisormanager\components\supervisor\exceptions\SupervisorException;
use app\modules\supervisormanager\components\supervisor\Supervisor;
use app\modules\supervisormanager\models\SupervisorGroupForm;
use yii\base\Event;
...
class DefaultController extends \backend\controllers\Controller
{
    ...
    {
        $this->title = Yii::t('admin', 'Supervisor Manager');
        $this->titleSmall = Yii::t('admin', 'Manage supervisor workers');
