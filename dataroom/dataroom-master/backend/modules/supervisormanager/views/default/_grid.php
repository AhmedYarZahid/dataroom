...
use app\modules\supervisormanager\components\gridView\GridView;
use app\modules\supervisormanager\components\widgets\ProcessPriorityWidget;
...
//                                    'options' => ['width' => '5%'],
                                    'value' => function($model) {
                                        ...
                                        $buttonBackgroundClass = 'danger';

                                        if ($model['state'] == 0) {
                                            $iconClass = 'play';

                                            $dataAction = 'startProcess';
                                            $buttonBackgroundClass = 'success';
                                        }
                                        ...
                                        return Html::tag(
                                            ...
                                            $content,
                                            [
                                                'class' => 'btn btn-' . $buttonBackgroundClass . ' processControl',
