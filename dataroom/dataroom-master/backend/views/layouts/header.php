...
<?php if (count(Yii::$app->params['languagesList']) > 1): ?>
    <li>
        <a class="change-language" href="<?= \yii\helpers\Url::current(['language' => Yii::$app->language == 'en' ? 'fr' : 'en']) ?>" title="<?= Yii::t('app', 'Change Language') ?>">
...
<li>
    <a href="<?= Yii::$app->urlManagerFrontend->createAbsoluteUrl(['']) ?>" title="<?= Yii::t('app', 'Go to frontend') ?>">
    ...
    <li class="dropdown user user-menu">
        ...
        <ul class="dropdown-menu">
            ...
            <li class="user-header bg-light-blue">
                ...
                <p>
                    <?= @Yii::$app->user->identity->fullName ?> - <?= Yii::t('admin', 'Admin') ?>
                    <!--<small>Member since <?/*= date('M. Y', strtotime(Yii::$app->user->identity->createdDate)) */?></small>-->
                </p>
            </li>
            <!-- Menu Body -->
            <!--<li class="user-body">
            ...
            <li class="user-footer">
                <div class="pull-left">
                    <a href="<?= \yii\helpers\Url::to(['/user/view', 'id' => Yii::$app->user->identity->id]); ?>"
                       class="btn btn-default btn-flat"><?= Yii::t('admin', 'Profile') ?></a>
                </div>
